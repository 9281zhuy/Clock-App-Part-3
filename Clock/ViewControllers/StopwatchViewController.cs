...
namespace Clock
{
	...
	{
		partial void BtnViewSplits_TouchUpInside(UIButton sender)
		{
			var Split = Storyboard.InstantiateViewController("SplitsViewController") as SplitsViewController;
			NavigationController.PushViewController(Split, true);
		}
